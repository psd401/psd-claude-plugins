...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "classintercom-pp-cli",
		Short: "Manage classintercom resources via the classintercom API",
		Long: `Manage classintercom resources via the classintercom API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'classintercom-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("classintercom-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'classintercom-pp-cli profile list')")
	...
	rootCmd.AddCommand(newContentCmd(flags))
	rootCmd.AddCommand(newLibrariesCmd(flags))
	rootCmd.AddCommand(newModerationCmd(flags))
	rootCmd.AddCommand(newReportsCmd(flags))
	rootCmd.AddCommand(newSocialCmd(flags))
	...
	rootCmd.AddCommand(newBinderPromotedCmd(flags))
	rootCmd.AddCommand(newChannelsPromotedCmd(flags))
	rootCmd.AddCommand(newCreateDraftCmd(flags))

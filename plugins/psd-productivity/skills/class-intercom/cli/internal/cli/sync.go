...
Resource scoping:
  ...
  classintercom-pp-cli sync

  # Sync specific resources only
  classintercom-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  classintercom-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  classintercom-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  classintercom-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  classintercom-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/classintercom-pp-cli/data.db)")
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"content-tasks",
		"libraries",
		"libraries-filters-config",
		"moderation",
		"moderation-filters-config",
		"reports",
		"reports-filters-config",
		"social",
		"social-filters-config",
		"tasks",
		"tasks-assignables",
		"tasks-filters-config",
	}
	return names
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"binder":                    "/api/binder/filters_config",
		"channels":                  "/api/channels",
		"content":                   "/api/content",
		"content-failed-count":      "/api/content/failed_count",
		"content-filters-config":    "/api/content/filters_config",
		"content-holidays":          "/api/content/holidays",
		"content-tasks":             "/api/content/tasks",
		"libraries":                 "/api/libraries",
		"libraries-filters-config":  "/api/libraries/filters_config",
		"moderation":                "/api/moderation",
		"moderation-filters-config": "/api/moderation/filters_config",
		"reports":                   "/api/reports",
		"reports-filters-config":    "/api/reports/filters_config",
		"social":                    "/api/social/feed",
		"social-filters-config":     "/api/social/filters_config",
		"tasks":                     "/api/tasks",
		"tasks-assignables":         "/api/tasks/assignables",
		"tasks-filters-config":      "/api/tasks/filters_config",
	}

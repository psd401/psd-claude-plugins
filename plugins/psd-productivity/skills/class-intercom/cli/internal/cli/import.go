...
but do not stop the import.`,
  ...
  classintercom-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  classintercom-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | classintercom-pp-cli import <resource> --input -`,

...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://app.classintercom.com/api/channels",
		EntryCount:    18,
		APIEntryCount: 18,
		...
		CandidateCommands: []string{
			"list_assignables — Derived from observed GET /api/tasks/assignables traffic.",
			"list_channels — Derived from observed GET /api/channels traffic.",
			"list_content — Derived from observed GET /api/content traffic.",
			"list_failed_count — Derived from observed GET /api/content/failed_count traffic.",
			"list_feed — Derived from observed GET /api/social/feed traffic.",
			"list_filters_config — Derived from observed GET /api/binder/filters_config traffic.",
			"list_holidays — Derived from observed GET /api/content/holidays traffic.",
			"list_libraries — Derived from observed GET /api/libraries traffic.",
		},
	}
}

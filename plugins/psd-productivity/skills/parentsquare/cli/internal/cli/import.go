...
but do not stop the import.`,
  ...
  parentsquare-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  parentsquare-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | parentsquare-pp-cli import <resource> --input -`,

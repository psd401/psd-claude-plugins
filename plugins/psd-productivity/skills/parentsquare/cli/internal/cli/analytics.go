...
Data must be synced first with the sync command.`,
  ...
  parentsquare-pp-cli analytics --type messages

  # Group by a field
  parentsquare-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  parentsquare-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,

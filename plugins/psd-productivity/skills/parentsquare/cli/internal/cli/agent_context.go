...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.parentsquare.com/districts/998/dashboard/students.json",
		EntryCount:    15,
		APIEntryCount: 15,
		...
		CandidateCommands: []string{
			"get_autocomplete — Derived from observed GET /districts/{district_id}/users/autocomplete traffic.",
			"get_class_events — Derived from observed GET /districts/{district_id}/class-events traffic.",
			"get_data_health_stats — Derived from observed GET /api/v2/districts/{district_id}/data_health_stats traffic.",
			"get_directory — Derived from observed GET /api/v2/schools/{school_id}/directory traffic.",
			"get_district_events — Derived from observed GET /districts/{district_id}/district-events traffic.",
			"get_group_events — Derived from observed GET /districts/{district_id}/group-events traffic.",
			"get_report_email_users — Derived from observed GET /schools/{school_id}/attendance_settings/report_email_users traffic.",
			"get_school_events — Derived from observed GET /districts/{district_id}/school-events traffic.",
		},
	}
}

...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "parentsquare-pp-cli",
		Short: "Manage parentsquare resources via the parentsquare API",
		Long: `Manage parentsquare resources via the parentsquare API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'parentsquare-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("parentsquare-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'parentsquare-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDistrictsCmd(flags))
	rootCmd.AddCommand(newSchoolsCmd(flags))
	rootCmd.AddCommand(newSectionsCmd(flags))
	rootCmd.AddCommand(newNotificationActivityCmd(flags))
	rootCmd.AddCommand(newDebugFetchCmd(flags))

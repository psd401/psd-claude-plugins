...
- Agent frontmatter: `model: claude-sonnet-5` (current standard — bare alias, no date suffix; the four heavy agents use `claude-opus-5-5`)
- Skill frontmatter: `model: claude-opus-5-5` (exception: `/plan` uses `claude-fable-5-1`)
...
- Old model IDs: `claude-opus-5` or `claude-opus-4-8` instead of `claude-opus-5-5`; `claude-fable-5` instead of `claude-fable-5-1`
